<div>
    <form action="post" wire:submit.prevent="store">
        ...
        <button type="button" class="bg-primary rounded-lg p-2 text-white" wire:click="limpar()">Limpar</button>
    </form>
    <div class="flex">
        <div class="w-full">
            <table class="w-full">
                ...
                <tbody>
                    ...
                    <tr class="border">
                        <td>{{$aviso->title}}</td>
                        <td>{{$aviso->body}}</td>
                        <td><button type="button" class="bg-primary rounded-lg p-1 text-white" wire:click="edit({{$aviso->id}})">Editar</button></td>
                        <td><button type="button" class="bg-primary rounded-lg p-1 text-white" wire:click="destroy({{$aviso->id}})">Remover</button></td>
    ...
    <button type="button" class="bg-primary rounded-lg p-2 text-white" wire:click="avisoUser()">Enviar Mensagem</button>
</div>